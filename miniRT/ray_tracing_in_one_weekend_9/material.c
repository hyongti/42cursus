...
/*   Updated: 2020/12/06 17:20:15 by root             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		lambertian_scatter(t_ray r_in, t_hit_record *rec, t_color *attenuation, t_ray *scattered)
{
...
int		metal_scatter(t_ray r_in, t_hit_record *rec, t_color *attenuation, t_ray *scattered)
{
	t_vec	reflected;
