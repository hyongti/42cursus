...
/*   Updated: 2020/12/12 18:42:17 by root             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int			main()
{
	...
	objects_add_back(&objects, objects_new(TR, triangle(point(-3, 2, -2), point(-1, 2, -3), point(-2, 3, -4), color(0, 0, 1))));
	...
	objects_add_back(&objects, objects_new(PL, plane(point(0, -6, 0), vec(0, 1, 0), color(111.0 / 255.0, 79.0 / 255.0, 40.0 / 255.0))));
	//Render
	int			i;
