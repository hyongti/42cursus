...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/01/11 20:52:12 by hyeonkim          #+#    #+#             */
/*   Updated: 2021/01/13 03:08:39 by hyeonkim         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
** 	unsigned int	size;	// 54 + 4 * width * hegith (32bit 비트맵 파일기준)
...
** 	unsigned int	color_important; // 비트맵을 표현하기 위해 필요한 색상 인덱스 수, 걍 0 떄려박어.
** };
*/
